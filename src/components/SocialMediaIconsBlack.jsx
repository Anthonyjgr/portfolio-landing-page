    ...
    return (
        <div className="flex justify-center md:justify-start my-4 gap-7">
            <a
                ...
                rel="noreferrer"
            >
                <img alt="linkedin-link" src="../assets/icons8-linkedin.svg" />
            </a>
            ...
            <a
                ...
                rel="noreferrer"
            >
                <img alt="Github-link" src="../assets/icons8-github.svg" />
            </a>
            <a
                className="hover:opacity-50 transition duration-500"
                ...
                rel="noreferrer"
            >
                <img alt="instagram-link" src="../assets/icons8-instagram.svg" />
            </a>
